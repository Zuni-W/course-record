...
typedef struct 
{
	unsigned long long rkh[SMS4_NUM_ROUNDS_BS][4];
	unsigned long long rkl[SMS4_NUM_ROUNDS_BS][4];
} sms4_key_t_bs;
...
void sms4_set_encrypt_key_bs(sms4_key_t_bs *key,unsigned long long *user_keyh,unsigned long long *user_keyl);
void SMS4_encrypt_bs(sms4_key_t_bs *key,unsigned long long *INh,unsigned long long *INl,unsigned long long *OUTh,unsigned long long *OUTl);
